...
public class TaskImportBlocksTest {
    ...
    public void testIsAlreadyStored() {
        ...
        while (current.getNumber() > 0) {
            ...
            assertThat(chain.getRepository().isBlockStored(current.getHash(), current.getNumber())).isTrue();
        ...
        assertThat(chain.getRepository().isBlockStored(current.getHash(), current.getNumber())).isFalse();
