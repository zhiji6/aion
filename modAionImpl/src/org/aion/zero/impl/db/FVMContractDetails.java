...
public class FVMContractDetails implements ContractDetails {
    ...
    public FVMContractDetails() {}

    @VisibleForTesting
    FVMContractDetails(int prune, int memStorageLimit) {
        this.prune = prune;
        // NOTE: updating this value can lead to incompatible data storage
     ...
     */
    public FVMContractDetails(ByteArrayKeyValueStore storageSource, ByteArrayKeyValueStore objectGraphSource) {
        this.dataSource = storageSource;
        this.objectGraphSource = objectGraphSource;
    }

    private FVMContractDetails(
    ...
    public FVMContractDetails(byte[] code) throws Exception {
        if (code == null) {
