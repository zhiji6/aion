...
public class AVMContractDetails implements ContractDetails {
    ...
    @VisibleForTesting
    AVMContractDetails(int prune, int memStorageLimit) {
        this.prune = prune;
        // NOTE: updating this value can lead to incompatible data storage
     ...
     */
    public AVMContractDetails(ByteArrayKeyValueStore storageSource, ByteArrayKeyValueStore objectGraphSource) {
